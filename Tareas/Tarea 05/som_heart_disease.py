...
fig.suptitle(" Kernel / Función de vecindad\n"
...
fig.suptitle("Visualización del Mapa de Kohonen\nHeart Disease UCI Dataset",
...
fig.suptitle("Densidades y Centroides\nHeart Disease UCI Dataset",
             fontsize=13, fontweight="bold")
