...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{scree_plot.pdf}
    \caption{Varianza explicada por componente principal.}
    \label{fig:scree}
\end{figure}

La estructura de cargas indica que PC1 concentra principalmente variables asociadas a urbanizaci\'on y presi\'on urbana, como \textit{indus}, \textit{nox}, \textit{rad}, \textit{tax}, \textit{age} y \textit{lstat}, mientras que \textit{rm} y \textit{dis} se mueven en sentido contrario. En t\'erminos interpretativos, PC1 puede leerse como un gradiente de deterioro/urbanizaci\'on versus calidad residencial.
